...
export const FESTIVAL_LANDINGS: FestivalLanding[] = [
...

  {
    ...
    capacity: "40.000 personas/día",
    blurb:
      "Creamfields Andalucía es el festival de música electrónica más importante del sur de España, celebrado en el Recinto González Hontoria de Jerez de la Frontera. Con los mejores DJs de techno, trance, house y EDM del mundo, atrae a 40.000 personas en 3 días. El recinto está a 5 km del centro de Jerez y a 35 km del aeropuerto de Jerez (XRY). Los visitantes de Sevilla (35 km), Cádiz (38 km), Málaga (180 km) y Madrid (600 km) llegan principalmente en coche o carpooling.",
