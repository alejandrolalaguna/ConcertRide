          ...
          <div className="relative">
            ...
            {open && (
              ...
              >
                ...
                <a href="/publish" onClick={() => setOpen(false)} role="menuitem"
                ...
                <a href="/mis-viajes" onClick={() => setOpen(false)} role="menuitem"
                  className="flex items-center gap-2 px-4 py-2.5 hover:bg-cr-surface-2 hover:text-cr-primary">
                  <TicketCheck size={12} aria-hidden="true" /> Mis viajes
                </a>
                <a href="/favoritos" onClick={() => setOpen(false)} role="menuitem"
                  className="flex items-center gap-2 px-4 py-2.5 hover:bg-cr-surface-2 hover:text-cr-primary">
