    ...
    >
      <div className="max-w-6xl mx-auto px-4 py-3 flex flex-col md:flex-row items-start md:items-center gap-3 md:gap-6">
        <p className="font-sans text-xs text-cr-text-muted flex-1 leading-relaxed">
          Usamos una cookie de sesión (<code className="font-mono text-cr-text text-[11px]">cr_session</code>) estrictamente
          necesaria. Opcionalmente, analítica anónima alojada en Europa (PostHog EU). Nunca publicidad.{" "}
          <a href="/cookies" className="text-cr-primary underline underline-offset-2 hover:text-cr-primary/80">
            Política de cookies
          </a>
        </p>
        <div className="flex-shrink-0 flex items-center gap-2">
          ...
          <button type="button" onClick={() => dismiss("accept_all")}
